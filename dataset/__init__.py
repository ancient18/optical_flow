...
class DataSet(data.Dataset):
    ...
    def __init__(self, args, train=True):
        self.args = args
        self.train = train
        self.data_root = args.data_root  # gopro or reds
        self.gopro_large_all_data_root = args.gopro_large_all_data_root  # gopro large all
    ...
    def add_noise(self, blur_image):
        ...
        if rate < self.gaussian_noise:
            ...
            blur_image = np.clip(blur_image, 0, 255).astype('uint8')   #限制在0-255之间
